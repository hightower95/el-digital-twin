from el_analysis import load_project_from_docs

# for additional convenience, we can also pass in the ProjectDocs dataclass
device_list_filename = "device_list.txt"
connection_list_filename = "connection_list.txt"
...
# Cable Summary
new_project.create_cable_summary()
...
# Device Summary
new_project.create_device_summary()

# Connector Summary
new_project.create_interface_summary()
# The output will look like this:
