...
#         else:
#             deserializer = None
#             for spec in self.connector_db._deserializers:
#                 if spec.can_parse_part_code(connector.part.part_type):
#                     deserializer = spec
#                     break
...
#         from sample_connector_db.connector_part import DBConnectorPart
        
#         connector_part = DBConnectorPart.from_part_code_string(connector.part.part_type)
...
# handler translates from DB objects to project objects
...
# connector_database = CustomConnectorDatabaseInterface(new_connector_database)
